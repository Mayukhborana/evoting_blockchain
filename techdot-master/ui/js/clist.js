...
$('.modal').modal();
 ...
 //    method: 'post'
	...
	contractInstance = VotingContract.at('0xc107c75AcC5ea56Df96140Fc99292402E5f2433b');
	...
	$('#vote4').click(function(){
		contractInstance.voteForCandidate('Arvind', {from: web3.eth.accounts[0]}, function() {
		    alert('vote submited to Arvind');
		     disable();
		     $('#loc_info').text('Vote submited successfully to Arvind kejriwal')
		});
	})
